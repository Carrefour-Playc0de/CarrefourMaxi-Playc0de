...
test('@Test @Regression @Carrito (TS-31) Verificar que al clickear los Carritos de varios productos del Almacen funciona correctamente', async ({selectSucursalArmaPedidoCAMPANAColectoraNorte1647}) => {
