...
test('@Regression @MenuHamburguesa (B2C-TC-1@Regression @MenuHamburguesa90) Verificar que funciona el Menu Desayuno y Merienda: VER TODO', async ({menuHamburDesayunoMeriendaVerTodo}) => {
...
test('@Regression @MenuHamburguesa (B2C-TC-936) Verificar que funciona el Menu Desayuno y Merienda: Cereales y Barritas', async ({menuHamburDesayunoMeriendaCerealesBarritas}) => {
