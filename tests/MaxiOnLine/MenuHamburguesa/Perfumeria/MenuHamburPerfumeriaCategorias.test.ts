...
test('@Regression @MenuHamburguesa (B2C-TC-1113) Verificar que funciona el Menu Perfumería: Algodones e Hisopos', async ({menuHamburPerfumeriaAlgodonesHisopos}) => {
...
test('@Regression @MenuHamburguesa(B2C-TC-1113) Verificar que funciona el Menu Perfumería: Antitranspirantes y Desodorantes', async ({menuHamburPerfumeriaAntitranspirantesDesodorantes}) => {
...
test('@Regression @MenuHamburguesa (B2C-TC-1113) Verificar que funciona el Menu Perfumería: Cuidado Corporal', async ({menuHamburPerfumeriaCuidadoCorporal}) => {
...
test('@Regression @MenuHamburguesa (B2C-TC-1113) Verificar que funciona el Menu Perfumería: Cuidado de la Piel', async ({menuHamburPerfumeriaCuidadoPiel}) => {
...
test('@Regression @MenuHamburguesa (B2C-TC-336) Verificar que funciona el Menu Perfumería: Cuidado Dental', async ({menuHamburPerfumeriaCuidadoDental}) => {
...
test('@Regression @MenuHamburguesa (B2C-TC-336) Verificar que funciona el Menu Perfumería: Farmacia', async ({menuHamburPerfumeriaFarmacia}) => {

    await test.step('Click en Farmacia', async () => {
        await menuHamburPerfumeriaFarmacia.navigateToMenuHamburPerfumeriaFarmacia()
    })
})
test('@Regression @MenuHamburguesa (B2C-TC-336) Verificar que funciona el Menu Perfumería: Jabones', async ({menuHamburPerfumeriaJabones}) => {

    await test.step('Click en Jabones', async () => {
        await menuHamburPerfumeriaJabones.navigateToMenuHamburPerfumeriaJabones()
    })
})
test('@Regression @MenuHamburguesa (B2C-TC-336) Verificar que funciona el Menu Perfumería: Proteccion Femenina', async ({menuHamburPerfumeriaProteccionFemenina}) => {
...
test('@Regression @MenuHamburguesa (B2C-TC-336) Verificar que funciona el Menu Perfumería: Proteccion para Adultos', async ({menuHamburPerfumeriaProteccionAdultos}) => {
...
test('@Regression @MenuHamburguesa (B2C-TC-336) Verificar que funciona el Menu Perfumería: Repelentes', async ({menuHamburPerfumeriaRepelentes}) => {
