...
test('@Regression @MenuHamburguesa (B2C-TC-1111) Verificar que funciona el Menu Limpieza: VER TODO', async ({menuHamburLimpiezaVerTodo}) => {

    await test.step('Click en Congelados VER TODO', async () => {
        await menuHamburLimpiezaVerTodo.navigateToMenuHamburLimpiezaVerTodo()
    })
})
test('@Regression @MenuHamburguesa (B2C-TC-335) Verificar que funciona el Menu Limpieza: Articulos de Limpieza', async ({menuHamburLimpiezaArticulosLimpieza}) => {
...
test('Regression @MenuHamburguesa (B2C-TC-335) Verificar que funciona el Menu Limpieza: Desodorantes de Ambiente', async ({menuHamburLimpiezaDesodorantesAmbiente}) => {
...
test('@Regression @MenuHamburguesa (B2C-TC-335) Verificar que funciona el Menu Limpieza: Insecticidas', async ({menuHamburLimpiezaInsecticidas}) => {

    await test.step('Click en Insecticidas', async () => {
        await menuHamburLimpiezaInsecticidas.navigateToMenuHamburLimpiezaInsecticidas()
    })
})
test('Regression @MenuHamburguesa (B2C-TC-335) Verificar que funciona el Menu Limpieza: Lavandinas', async ({menuHamburLimpiezaLavandinas}) => {

    await test.step('Click en Lavandinas', async () => {
        await menuHamburLimpiezaLavandinas.navigateToMenuHamburLimpiezaLavandinas()
    })
})
test('Regression @MenuHamburguesa (B2C-TC-335) Verificar que funciona el Menu Limpieza: Limpieza de Banio', async ({menuHamburLimpiezaLimpiezaBanio}) => {
...
test('Regression @MenuHamburguesa (B2C-TC-335) Verificar que funciona el Menu Limpieza: Limpieza de Cocina', async ({menuHamburLimpiezaLimpiezaCocina}) => {
...
test('Regression @MenuHamburguesa (B2C-TC-335) Verificar que funciona el Menu Limpieza: Limpieza de Pisos y Muebles', async ({menuHamburLimpiezaLimpiezaPisosMuebles}) => {
...
test('Regression @MenuHamburguesa (B2C-TC-335) Verificar que funciona el Menu Limpieza: Limpieza de la Ropa', async ({menuHamburLimpiezaLimpiezaRopa}) => {
...
test('@Regression @MenuHamburguesa (B2C-TC-335) Verificar que funciona el Menu Limpieza: Papeles Higienicos', async ({menuHamburLimpiezaPapelesHigienicos}) => {
...
test('@Regression @MenuHamburguesa (B2C-TC-335) Verificar que funciona el Menu Limpieza: Rollos de Cocina y Servilletas', async ({menuHamburLimpiezaRollosCocinaServilletas}) => {
