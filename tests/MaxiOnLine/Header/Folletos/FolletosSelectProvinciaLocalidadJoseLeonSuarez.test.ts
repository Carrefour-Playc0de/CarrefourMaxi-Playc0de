...
test('@Test @Regression @Header (TS-31) Verificar que al clickear en la opcion Jose Leon Suarez del select Provincia funciona correctamente', async ({folletosSelectProvinciaLocalidadJoseLeonSuarez}) => {
