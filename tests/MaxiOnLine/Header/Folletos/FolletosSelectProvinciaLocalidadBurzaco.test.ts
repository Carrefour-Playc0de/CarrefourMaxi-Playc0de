...
test('@Test @Regression @Header (TS-31) Verificar que al clickear en la opcion Burzaco del select Provincia funciona correctamente', async ({folletosSelectProvinciaLocalidadBurzaco}) => {
