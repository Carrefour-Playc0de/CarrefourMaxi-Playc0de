...
test('@Test @Regression @Header (TS-31) Verificar que al clickear en la opcion Mendoza del select Provincia funciona correctamente', async ({folletosSelectProvinciaLocalidadMendoza}) => {
